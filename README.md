...
- 🛠️ **Admin Console** — manage users (including removal), manage officers, manage accounts, add new officers with a one-time temporary password
...
If you already have a `banking_system` database from an older version of this project, see [`backend/README.md`](backend/README.md) for manual migration statements instead of re-running the full schema.
